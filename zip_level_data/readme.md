...
Below are the time-series files starting with the first date of capture on May 1. We'll eventually start combining these into a single file to show growth over time.
 ...
 - Sept. 25 | [full geoJSON file](time_series_data/full_geojson/nc_zip0925.geojson) | [reduced geoJSON file](time_series_data/reduced_geojson/nc_zip0925.json) | [CSV file](time_series_data/csv/nc_zip0925.csv) * Note: NCDHHS noted on 9/25 that they were not including both PCR and antigen tests in their results of cases and deaths. [They posted an FAQ of the changes here](https://files.nc.gov/covid/documents/dashboard/Antigen-Testing-Frequently-Asked-Questions.pdf), but they'll mean more cases/deaths as of this date going forward. *
 - Sept. 26 | [full geoJSON file](time_series_data/full_geojson/nc_zip0926.geojson) | [reduced geoJSON file](time_series_data/reduced_geojson/nc_zip0926.json) | [CSV file](time_series_data/csv/nc_zip0925.csv)
